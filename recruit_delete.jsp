...
PreparedStatement ps=con.prepareStatement("delete from recruit where app_id=?");
ps.setString(1, app_id);
int flag=ps.executeUpdate();
%>
<% if(flag>0){ %>
<h3> values deleted successfully</h3>
<p> <a href="recruit_delete.html"><button type="button">BACK</button></a></p>
<%} else {%>
